...
public class CRWorldGen{
	...
	public static PlacementModifierType<OreConfigFilter> oreConfigPlacementModifierType;
	...
	public static void init(){
		...
		toRegisterModifier.put("ore_config", oreConfigPlacementModifierType = (() -> OreConfigFilter.CODEC));
