...
public class BakedModelLoader implements ICustomModelLoader{
	...
	public boolean accepts(ResourceLocation modelLocation){
		return modelLocation == ConduitBakedModel.BAKED_MODEL || modelLocation == PrototypeBakedModel.BAKED_MODEL;
	}

	@Override
	public IModel loadModel(ResourceLocation modelLocation) throws Exception{
		return modelLocation == ConduitBakedModel.BAKED_MODEL ? CONDUIT_MODEL : PROTOTYPE_MODEL;
	}
}
