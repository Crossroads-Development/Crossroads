...
public class RiftEffect implements IEffect{
	...
	public void doEffect(World worldIn, BlockPos pos, double mult){
		...
		if(worldServ.countEntities(EnumCreatureType.MONSTER, true) <= EnumCreatureType.MONSTER.getMaxNumberOfCreature() && rand.nextInt(128) <= mult){
	...
	public static class VoidRiftEffect implements IEffect{
		...
		public void doEffect(World worldIn, BlockPos pos, double mult){
			WorldServer worldServ = (WorldServer) worldIn;
			if(worldServ.countEntities(EnumCreatureType.CREATURE, true) <= EnumCreatureType.CREATURE.getMaxNumberOfCreature() && rand.nextInt(128) <= mult){
