...
public interface IMechArmEffect{
	 ...
	 */
	public boolean onTriggered(World world, BlockPos pos, double posX, double posY, double posZ, @Nullable Direction side, @Nonnull EntityArmRidable ent, MechanicalArmTileEntity te);
