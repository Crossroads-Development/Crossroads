...
public final class AlchemyCraftingManager{
	...
	static{
		...
		REAGENTS[11] = new SimpleReagentType("aqua_regia", 0D, 100D, 11, (MatterPhase phase) -> Color.ORANGE, null, 1, true, 0, SolventType.AQUA_REGIA, null, 0, new AquaRegiaAlchemyEffect());// Shouldn't really be its own substance (actually a mixture of nitric and hydrochloric acid), but the code is greatly																																											// simplified by making it a separate substance.
		...
		REAGENTS[16] = new SimpleReagentType("waste_salt", 900D, 1400D, 16, (MatterPhase phase) -> TRANSLUCENT_WHITE_COLOR, null, 1, true, 0, null, SolventType.POLAR, 0, null);//Any salt byproduct that is too boring to bother adding. TODO salt effect, item.  
		...
		REAGENTS[18] = new SimpleReagentType("philosopher_stone", Short.MAX_VALUE - 1, Short.MAX_VALUE, 18, (MatterPhase phase) -> Color.BLACK, null, 100, true, 1, null, null, 2, null);// TODO item
		REAGENTS[19] = new SimpleReagentType("practitioner_stone", Short.MAX_VALUE - 1, Short.MAX_VALUE, 19, (MatterPhase phase) -> Color.BLACK, null, 100, true, 2, null, null, 2, null);// TODO item
		...
		REAGENTS[22] = new SimpleReagentType("alchemical_crystal", Short.MAX_VALUE - 1, Short.MAX_VALUE, 22, (MatterPhase phase) -> CLEAR_COLOR, null, 10, true, 0, null, null, 0, null);//TODO item
