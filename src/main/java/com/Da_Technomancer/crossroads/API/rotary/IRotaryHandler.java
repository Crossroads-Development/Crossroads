 ...
 * Not for things that interact with the rotary system externally (ex. pump) The
 * master axis does not carry rotary energy in itself.
 * 
 * Also, please note that some tile entities with this capability will return
 * false to hasCapability if member == null, but will still return the handler
 * with getCapability, for setting the member. Not all tile entities with this
 * capability act that way though
 */
