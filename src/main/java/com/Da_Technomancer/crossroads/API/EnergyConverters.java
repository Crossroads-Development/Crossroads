...
public final class EnergyConverters{
	...
	/**
	 * The number of degrees one bucket of steam is worth. Based on game
	 * balance.
	 */
	 ...
	 * conversion is too simple (Heat capacity, thermodynamics, dimensions,
	 * etc.)
	 */
	public static final double DEG_PER_JOULE = 4D;

	/**
	 * The number of millibuckets of liquid fat that is equivalent to 1 food
