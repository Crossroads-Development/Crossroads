...
public class FluxUtil{
	...
	public static void renderFlux(World world, BlockPos src, BlockPos dest, int qty){
		if(qty > 0){
			...
			CRRenderUtil.addArc(world, src.getX() + 0.5F, src.getY() + 0.5F, src.getZ() + 0.5F, dest.getX() + 0.5F, dest.getY() + 0.5F, dest.getZ() + 0.5F, src.getX() + 0.5F, src.getY() + 0.5F, src.getZ() + 0.5F, 3, 0F, (byte) FLUX_TIME, COLOR_CODES[(int) (world.getGameTime() % 3)], false);
		}
	}
