		...
		public void setMagic(MagicUnit mag){
			...
			switch(contents){
				case 0:
					...
					break;
				case 1:
					if(beamer[dir == AxisDirection.POSITIVE ? 1 : 0].emit(mag == null || mag.getEnergy() == 0 ? null : new MagicUnit(mag.getEnergy(), 0, 0, 0), world)){
						refreshBeam(dir == AxisDirection.POSITIVE);
					}
					break;
				case 2:
					if(beamer[dir == AxisDirection.POSITIVE ? 1 : 0].emit(mag == null || mag.getPotential() == 0 ? null : new MagicUnit(0, mag.getPotential(), 0, 0), world)){
						refreshBeam(dir == AxisDirection.POSITIVE);
					}
					break;
				case 3:
					if(beamer[dir == AxisDirection.POSITIVE ? 1 : 0].emit(mag == null || mag.getStability() == 0 ? null : new MagicUnit(0, 0, mag.getStability(), 0), world)){
						refreshBeam(dir == AxisDirection.POSITIVE);
					}
					break;
				case 4:
				...
				case 5:
					...
					break;
				case 6:
					if(beamer[dir == AxisDirection.POSITIVE ? 1 : 0].emit(mag == null ? null : new MagicUnit(0, 0, 0, mag.getPower()), world)){
						refreshBeam(dir == AxisDirection.POSITIVE);
					}
					break;
			}
