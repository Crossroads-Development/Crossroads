...
public class SinAxisTileEntity extends TileEntity implements ITickable{
	...
	public SinAxisTileEntity(){
		this(EnumFacing.NORTH);
	}

	public SinAxisTileEntity(EnumFacing facingIn){
		super();
		facing = facingIn;
	}
	...
	private void runCalc(){
		...
		double baseSpeed = Math.sin(inBack);
