...
public class ArcSinAxisTileEntity extends TileEntity implements ITickable{
	...
	public ArcSinAxisTileEntity(){
		this(EnumFacing.NORTH);
	}

	public ArcSinAxisTileEntity(EnumFacing facingIn){
		super();
		facing = facingIn;
	}
	...
	private void runCalc(){
		...
		double baseSpeed = inBack < -1 || inBack > 1 ? 0 : Math.asin(inBack);
