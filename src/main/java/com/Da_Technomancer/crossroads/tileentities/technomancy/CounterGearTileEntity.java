...
public class CounterGearTileEntity extends TileEntity implements ITickable, IDoubleReceiver{
	...
	public CounterGearTileEntity(){
		super();
	}
	
	public CounterGearTileEntity(GearTypes type){
		super();
		this.type = type;
