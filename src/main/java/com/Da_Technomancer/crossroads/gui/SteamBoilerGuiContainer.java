...
public class SteamBoilerGuiContainer extends MachineGUI{
	...
	public void initGui(){
		...
		guiObjects[0] = new FluidGuiObject(this, 0,10_000, (width - xSize) / 2, (height - ySize) / 2, 10, 70);
		guiObjects[1] = new FluidGuiObject(this, 1,10_000, (width - xSize) / 2, (height - ySize) / 2, 70, 70);
	}
