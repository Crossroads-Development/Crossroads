...
public class BasicBlock extends Block{
	...
	//This class can define any block without any special properties or TileEntity attached.
    ...
    public BasicBlock(String unlocName, Material mat, int mineLevel, String tool, float hardness, Item drop, String oreDict, Boolean allowFort, int dropCount) {
    	super(mat);
    	if(tool != null && mineLevel != -2) this.setHarvestLevel(tool, mineLevel);
    	this.drop = drop;
		...
		if(oreDict!=null)OreDictionary.registerOre(oreDict, this);
