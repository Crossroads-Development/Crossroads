...
public class ColdStorage extends ContainerBlock implements IReadable{
	...
	public TileEntity newBlockEntity(IBlockReader worldIn){
		return new ColdStorageTileEntity();
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader world, List<ITextComponent> tooltip, ITooltipFlag advanced){
		tooltip.add(new TranslationTextComponent("tt.crossroads.cold_storage.desc"));
		tooltip.add(new TranslationTextComponent("tt.crossroads.cold_storage.drain", ColdStorageTileEntity.LOSS_PER_ITEM));
		tooltip.add(new TranslationTextComponent("tt.crossroads.cold_storage.redstone"));
