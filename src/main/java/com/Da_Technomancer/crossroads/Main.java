...
@Mod(modid = Main.MODID, name = Main.MODNAME, version = Main.VERSION, dependencies = "required-after:forge@[13.20.0.2271,]; before:guideapi; after:jei; after:crafttweaker", useMetadata = true)
