...
//			//entries.put(new ResourceLocation(Main.MODID, "rotary"), new SmartEntry("lore.rotary.name", new ItemStack(GearFactory.BASIC_GEARS[GearFactory.GearMaterial.BRONZE.ordinal()], 1), "lore.rotary"));
...
//
//			// HEAT
//			entries.put(new ResourceLocation(Main.MODID, "fuel_heater"), new SmartEntry("lore.fuel_heater", new ItemStack(ModBlocks.firebox, 1), "lore.fuel_heater.text", new ShapedOreRecipe(null, new ItemStack(ModBlocks.firebox, 1), "#*#", "# #", "###", '#', "cobblestone", '*', "ingotCopper")));
//			entries.put(new ResourceLocation(Main.MODID, "heating_chamber"), new SmartEntry("lore.heating_chamber", new ItemStack(ModBlocks.smelter, 1), "lore.heating_chamber.text", new ShapedOreRecipe(null, new ItemStack(ModBlocks.smelter, 1), "#*#", "# #", "###", '#', "ingotIron", '*', "ingotCopper")));
//			entries.put(new ResourceLocation(Main.MODID, "heat_exchanger"), new SmartEntry("lore.heat_exchanger", new ItemStack(ModBlocks.heatSink, 1), "lore.heat_exchanger.text", new ShapedOreRecipe(null, new ItemStack(ModBlocks.heatSink, 1), "#$#", "$$$", "###", '#', Blocks.IRON_BARS, '$', "ingotCopper")));
//			entries.put(new ResourceLocation(Main.MODID, "heating_crucible"), new SmartEntry("lore.heating_crucible", new ItemStack(ModBlocks.smelter, 1), "lore.heating_crucible.text", new ShapedOreRecipe(null, new ItemStack(ModBlocks.heatingCrucible, 1), "# #", "#?#", "###", '#', Blocks.HARDENED_CLAY, '?', Items.CAULDRON)));
...
//
//			categories.add(new CategoryItemStack(entries, "Heat Machines", new ItemStack(ModBlocks.smelter, 1)));
//			entries = new LinkedHashMap<ResourceLocation, EntryAbstract>();
//
//			// ROTARY
...
//			pages = new ArrayList<IPage>();
//			createPages(pages, "lore.steam_turbine.pre_recipe", new ShapelessOreRecipe(null, new ItemStack(ModBlocks.steamTurbine, 1), ModBlocks.rotaryPump), new ShapelessOreRecipe(null, new ItemStack(ModBlocks.rotaryPump, 1), ModBlocks.steamTurbine), Pair.of("lore.steam_turbine.post_recipe", new Object[] {EnergyConverters.degPerSteamBucket(true) / EnergyConverters.degPerJoule(true)}));
...
//			pages = new ArrayList<IPage>();
//			entries.put(new ResourceLocation(Main.MODID, "radiator"), new SmartEntry("lore.radiator.name", new ItemStack(ModBlocks.radiator, 1), Pair.of("lore.radiator", new Object[] {EnergyConverters.degPerSteamBucket(true)}), new ShapedOreRecipe(null, new ItemStack(ModBlocks.radiator, 1), "#$#", "#$#", "#$#", '#', ModBlocks.fluidTube, '$', "ingotIron"), ((Supplier<Object>) () -> {return ModConfig.getConfigBool(ModConfig.weatherControl, true) ? "lore.radiator.bobo_rain_idol" : null;})));
...
//			entries.put(new ResourceLocation(Main.MODID, "fertile_soil"), new SmartEntry("lore.fertile_soil.name", new ItemStack(EssentialsBlocks.fertileSoilWheat, 1), "lore.fertile_soil"));
//			entries.put(new ResourceLocation(Main.MODID, "item_chute"), new SmartEntry("lore.item_chute.name", new ItemStack(EssentialsBlocks.itemShifter, 1), "lore.item_chute.start", "lore.item_chute.default"));
...
//			pages = new ArrayList<IPage>();
//			createPages(pages, "lore.arcane_extractor.pre_recipe", new ShapedOreRecipe(null, new ItemStack(ModBlocks.beamExtractor, 1), "***", "*# ", "***", '*', "stone", '#', ModItems.lensArray), "lore.arcane_extractor.post_recipe");
//			entries.put(new ResourceLocation(Main.MODID, "arcane_extractor"), new EntryItemStack(pages, "Arcane Extractor", new ItemStack(ModBlocks.beamExtractor, 1), true));
//			pages = new ArrayList<IPage>();
//			createPages(pages, "lore.quartz_stabilizer.pre_recipe", new ShapedOreRecipe(null, new ItemStack(ModBlocks.quartzStabilizer, 1), " * ", "*&*", "***", '*', ModItems.pureQuartz, '&', ModItems.lensArray), "lore.quartz_stabilizer.mid_recipe", new ShapedOreRecipe(null, new ItemStack(ModBlocks.quartzStabilizer, 1), " & ", "***", '&', ModItems.luminescentQuartz, '*', ModItems.pureQuartz), "lore.quartz_stabilizer.post_recipe");
//			entries.put(new ResourceLocation(Main.MODID, "quartz_stabilizer"), new EntryItemStack(pages, "Quartz Stabilizer", new ItemStack(ModBlocks.quartzStabilizer, 1), true));
//			pages = new ArrayList<IPage>();
//			createPages(pages, "lore.lens_holder.pre_recipe", new ShapedOreRecipe(null, new ItemStack(ModBlocks.lensFrame, 1), "***", "*&*", "***", '*', "stone", '&', ModItems.pureQuartz), "lore.lens_holder.post_recipe");
//			entries.put(new ResourceLocation(Main.MODID, "lens_holder"), new EntryItemStack(pages, "Lens Holder", new ItemStack(ModBlocks.lensFrame, 1), true));
//			pages = new ArrayList<IPage>();
//			createPages(pages, "lore.arcane_reflector", new ShapedOreRecipe(null, new ItemStack(ModBlocks.beamReflector, 1), "*^*", '*', "stone", '^', ModItems.pureQuartz));
//			entries.put(new ResourceLocation(Main.MODID, "arcane_reflector"), new EntryItemStack(pages, "Arcane Reflector", new ItemStack(ModBlocks.beamReflector, 1), true));
//			pages = new ArrayList<IPage>();
////TODO			createPages(pages, "lore.beam_splitter", new ShapedOreRecipe(null, new ItemStack(ModBlocks.beamSplitterBasic, 1), "*^*", "*&*", "*^*", '*', ModItems.pureQuartz, '^', ModItems.luminescentQuartz, '&', ModItems.lensArray), new ShapelessOreRecipe(null, new ItemStack(ModBlocks.beamSiphon, 1), ModBlocks.beamSplitterBasic, "dustRedstone", "dustRedstone", "dustRedstone"));
//			entries.put(new ResourceLocation(Main.MODID, "beam_splitter"), new EntryItemStack(pages, "Beam Splitter", new ItemStack(ModBlocks.beamSiphon, 1), true));
//			pages = new ArrayList<IPage>();
...
//			entries.put(new ResourceLocation(Main.MODID, "heat_limiter"), new SmartEntry("lore.heat_limiter.name", new ItemStack(ModBlocks.heatLimiterRedstone, 1), "lore.heat_limiter"));
...
//			entries.put(new ResourceLocation(Main.MODID, "rotary"), new SmartEntry("info.rotary.name", new ItemStack(GearFactory.BASIC_GEARS[GearFactory.GearMaterial.BRONZE.ordinal()], 1), "info.rotary"));
...
//
//			// HEAT
//			entries.put(new ResourceLocation(Main.MODID, "fuel_heater"), new SmartEntry("info.fuel_heater", new ItemStack(ModBlocks.firebox, 1), "info.fuel_heater.text", new ShapedOreRecipe(null, new ItemStack(ModBlocks.firebox, 1), "#*#", "# #", "###", '#', "cobblestone", '*', "ingotCopper")));
//			entries.put(new ResourceLocation(Main.MODID, "heating_chamber"), new SmartEntry("info.heating_chamber", new ItemStack(ModBlocks.smelter, 1), "info.heating_chamber.text", new ShapedOreRecipe(null, new ItemStack(ModBlocks.smelter, 1), "#*#", "# #", "###", '#', "ingotIron", '*', "ingotCopper")));
//			entries.put(new ResourceLocation(Main.MODID, "heat_exchanger"), new SmartEntry("info.heat_exchanger", new ItemStack(ModBlocks.heatSink, 1), "info.heat_exchanger.text", new ShapedOreRecipe(null, new ItemStack(ModBlocks.heatSink, 1), "#$#", "$$$", "###", '#', Blocks.IRON_BARS, '$', "ingotCopper")));
//			entries.put(new ResourceLocation(Main.MODID, "heating_crucible"), new SmartEntry("info.heating_crucible", new ItemStack(ModBlocks.smelter, 1), "info.heating_crucible.text", new ShapedOreRecipe(null, new ItemStack(ModBlocks.heatingCrucible, 1), "# #", "#?#", "###", '#', Blocks.HARDENED_CLAY, '?', Items.CAULDRON)));
...
//			entries.put(new ResourceLocation(Main.MODID, "steam_turbine"), new EntryItemStack(pages, "Steam Turbine", new ItemStack(ModBlocks.steamTurbine, 1), true));
//			pages = new ArrayList<IPage>();
//			createPages(pages, Pair.of("info.radiator", new Object[] {EnergyConverters.degPerSteamBucket(true)}), new ShapedOreRecipe(null, new ItemStack(ModBlocks.radiator, 1), "#$#", "#$#", "#$#", '#', ModBlocks.fluidTube, '$', "ingotIron"));
...
//			entries.put(new ResourceLocation(Main.MODID, "fertile_soil"), new SmartEntry("info.fertile_soil.name", new ItemStack(EssentialsBlocks.fertileSoilWheat, 1), "info.fertile_soil"));
//			entries.put(new ResourceLocation(Main.MODID, "item_chute"), new SmartEntry("info.item_chute.name", new ItemStack(EssentialsBlocks.itemShifter, 1), "info.item_chute.start", "info.item_chute.default"));
...
//			entries.put(new ResourceLocation(Main.MODID, "color_chart"), new EntryItemStack(pages, "Discovering Elements", new ItemStack(ModBlocks.colorChart, 1), true));
//			pages = new ArrayList<IPage>();
//			createPages(pages, "info.arcane_extractor", new ShapedOreRecipe(null, new ItemStack(ModBlocks.beamExtractor, 1), "***", "*# ", "***", '*', "stone", '#', ModItems.lensArray));
//			entries.put(new ResourceLocation(Main.MODID, "arcane_extractor"), new EntryItemStack(pages, "Arcane Extractor", new ItemStack(ModBlocks.beamExtractor, 1), true));
//			pages = new ArrayList<IPage>();
//			createPages(pages, "info.quartz_stabilizer", new ShapedOreRecipe(null, new ItemStack(ModBlocks.quartzStabilizer, 1), " * ", "*&*", "***", '*', ModItems.pureQuartz, '&', ModItems.lensArray), new ShapedOreRecipe(null, new ItemStack(ModBlocks.quartzStabilizer, 1), " & ", "***", '&', ModItems.luminescentQuartz, '*', ModItems.pureQuartz));
//			entries.put(new ResourceLocation(Main.MODID, "quartz_stabilizer"), new EntryItemStack(pages, "Quartz Stabilizer", new ItemStack(ModBlocks.quartzStabilizer, 1), true));
//			pages = new ArrayList<IPage>();
//			createPages(pages, "info.lens_holder", new ShapedOreRecipe(null, new ItemStack(ModBlocks.lensFrame, 1), "***", "*&*", "***", '*', "stone", '&', ModItems.pureQuartz));
//			entries.put(new ResourceLocation(Main.MODID, "lens_holder"), new EntryItemStack(pages, "Lens Holder", new ItemStack(ModBlocks.lensFrame, 1), true));
//			pages = new ArrayList<IPage>();
//			createPages(pages, "info.arcane_reflector", new ShapedOreRecipe(null, new ItemStack(ModBlocks.beamReflector, 1), "*^*", '*', "stone", '^', ModItems.pureQuartz));
//			entries.put(new ResourceLocation(Main.MODID, "arcane_reflector"), new EntryItemStack(pages, "Arcane Reflector", new ItemStack(ModBlocks.beamReflector, 1), true));
//			pages = new ArrayList<IPage>();
...
//			entries.put(new ResourceLocation(Main.MODID, "heat_limiter"), new SmartEntry("info.heat_limiter.name", new ItemStack(ModBlocks.heatLimiterRedstone, 1), "info.heat_limiter"));
