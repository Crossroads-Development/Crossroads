...
public class StampMillCategory implements IRecipeCategory<StampMillRecipe>{
	...
	public static final String ID = Main.MODID + ".stamp_mill";
	...
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, StampMillRecipe recipeWrapper, IIngredients ingredients){
