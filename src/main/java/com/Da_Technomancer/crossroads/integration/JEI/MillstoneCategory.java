...
public class MillstoneCategory implements IRecipeCategory<MillRec>{
	...
	protected MillstoneCategory(IGuiHelper guiHelper){
		...
		icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM, new ItemStack(CRBlocks.millstone, 1));
	}
	...
	@Override
	public void draw(MillRec recipe, IRecipeSlotsView view, PoseStack matrix, double mouseX, double mouseY){
