...
public class JEICrossroadsPlugin implements IModPlugin{
	...
	public void registerRecipeTransferHandlers(IRecipeTransferRegistration registration){
		registration.addRecipeTransferHandler(DetailedCrafterContainer.class, DetailedCrafterCategory.TYPE, 1, 9, 10, 36);
		registration.addRecipeTransferHandler(DetailedCrafterContainer.class, RecipeTypes.CRAFTING, 1, 9, 10, 36);
