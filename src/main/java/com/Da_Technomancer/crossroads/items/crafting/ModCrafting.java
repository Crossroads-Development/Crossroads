...
public final class ModCrafting{
	...
	public static void init(){
		...
		RecipeHolder.alchemyRecipes.add(new ShapedOreRecipe(null, new ItemStack(ModBlocks.teslaCoilTopDecorative, 1), "TTT", "TCT", "TTT", 'T', "blockGlass", 'C', ModBlocks.teslaCoilTopNormal));
		//Vanadium
