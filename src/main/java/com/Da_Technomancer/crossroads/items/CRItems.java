...
public final class CRItems{
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<BeamUnit>> BEAM_SETTING_DATA = DATA_COMPONENTS.registerComponentType("setting", builder -> builder.persistent(BeamUnit.CODEC).networkSynchronized(BeamUnit.STREAM_CODEC));
